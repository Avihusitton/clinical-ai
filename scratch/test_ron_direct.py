...
c = requests.post(f'http://127.0.0.1:8765/api/therapists/{tid}/patients/{pid}/conversations', json={'title':'שיחת רון 3'}).json()['conversation']
cid = c['id']
...
with open('scratch/direct_answer.jsonl', 'w', encoding='utf-8') as f:
